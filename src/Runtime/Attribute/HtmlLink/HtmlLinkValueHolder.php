...
class HtmlLinkValueHolder extends ValueHolder
{
    ...
    protected function valueEquals($other_value)
    {
        ...
        } elseif ($other_value instanceof HtmlLink) {
     ...
     * to reconstitute it.
     *
     * @return array|null value that can be used for serializing/deserializing
     */
    public function toNative()
    {
        if (!$this->getValue() instanceof HtmlLink) {
            return null;
        }
