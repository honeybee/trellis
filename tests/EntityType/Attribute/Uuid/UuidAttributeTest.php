...
class UuidAttributeTest extends TestCase
{
    ...
    public function testCreateValue()
    {
        ...
        $this->assertInstanceOf(Uuid::CLASS, $uuid_attribute->createValue($entity));
        $this->assertInstanceOf(Uuid::CLASS, $uuid_attribute->createValue($entity, Uuid::generate()));
        $this->assertInstanceOf(
            Uuid::CLASS,
            $uuid_attribute->createValue($entity, '375ef3c0-db23-481a-8fdb-533ac47fb9f0')
        );
    }
}
