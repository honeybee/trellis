...
class KeyValueListAttributeTest extends TestCase
{
    ...
    public function testCreateValue()
    {
        ...
        $this->assertInstanceOf(KeyValueList::CLASS, $kv_list->createValue());
        $this->assertInstanceOf(
            KeyValueList::CLASS,
            $kv_list->createValue(new KeyValueList([ 'message' => 'hello world!' ]))
        );
        $this->assertInstanceOf(KeyValueList::CLASS, $kv_list->createValue([ 'message' => 'hello world!' ]));
    }
}
